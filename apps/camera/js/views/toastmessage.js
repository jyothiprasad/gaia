...
module.exports = View.extend({
  ...
  lowBatteryMsg:function(value){
    if(value <=15 && value >10)
      var msg = "<img class='lowbattery'  src = 'style/images/Battery_15_Percent.svg'/> <br/>You have "+value+"% battery remaining";
    else if(value <= 10 && value >6)
      var msg = "<img class='lowbattery'  src = 'style/images/Battery_10_Percent.svg'/> <br/>You have "+value+"% battery remaining";
    else if(value == 6)
      var msg = "<img class='lowbattery'  src = 'style/images/Battery_10_Percent.svg' /> <br/>Critically low battery";
    return msg;
}
